...
class SurfacePositionV1MsgTest extends SurfacePositionMsgTest {
    ...
    @Override
    protected MovementV0V1 movement(byte encoded) {
        return MovementV0V1.forEncoded(encoded);
    }
    ...
    void testGetNICWithSupplementA() throws Exception {
        ...
        assertEquals(9, sPos.getNavigationCharacteristics(NICSupplements.none().withA(true)).getNICEncoded());
    }
    ...
    void testGetHorizontalContainmentRadiusLimitWithSupplementA() throws Exception {
        ...
        assertEquals(75, sPos.getNavigationCharacteristics(NICSupplements.none().withA(true)).getHorizontalContainmentRadiusLimit());
    }
}
