...
/**
 * Decoder for ADS-R version 2 airspeed and heading messages, as defined in ED-102A
 * §2.2.18.4.4 Figure 2-36, which gives the differences from the ADS-B format of ED-102B
 * Appendix N §N.5.3 Figure N-20 (Version Two Airborne Velocity Message Subtypes 3 &amp; 4).
