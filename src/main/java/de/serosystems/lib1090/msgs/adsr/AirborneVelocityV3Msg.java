 ...
 */
public class AirborneVelocityV3Msg extends ExtendedSquitter implements Serializable, VelocityOverGroundMsg, IMFMsg, NACvMsg {
    ...
    public subtype getType() {
        return subtype.ADSR_VELOCITY_V3;
    }
}
