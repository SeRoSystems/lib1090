...
public class AirbornePositionV2Msg extends AirbornePositionV1Msg implements Serializable {
     ...
     */
    public AirbornePositionV2Msg(String rawMessage, Long timestamp) throws BadFormatException, UnspecifiedFormatError {
     ...
     * @throws UnspecifiedFormatError if message has format that is not further specified in DO-260B
     */
    public AirbornePositionV2Msg(byte[] rawMessage, Long timestamp) throws BadFormatException, UnspecifiedFormatError {
        this(new ExtendedSquitter(rawMessage), timestamp);
    }
