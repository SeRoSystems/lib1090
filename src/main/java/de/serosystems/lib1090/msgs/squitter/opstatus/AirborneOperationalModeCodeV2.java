...
/**
 * The Operational Mode (OM) Code of an ADS-B or ADS-R version 2 airborne operational status message,
 ...
 * antenna (30), SDA (31–32). ME 33–40 are reserved, and carry the CCCB and remain-well-clear flag in
 * version 3.
 */
public class AirborneOperationalModeCodeV2 extends AbstractMEField
        implements OperationalModeCodeV1V2, OperationalModeCodeV2V3 {

    private static final long serialVersionUID = -8109674421563550929L;
     ...
     **/
    protected AirborneOperationalModeCodeV2() {
    }
     ...
     */
    public AirborneOperationalModeCodeV2(int encoded) {
