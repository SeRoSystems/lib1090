...
/**
 * The Capability Class (CC) Code of a version 2 surface operational status message, ME 9–20.
 * <p>
 * Shared by ADS-B and ADS-R. The class carries no accessors of its own.
 * <p>
 * Subfields: 1090ES IN (ME 12), B2 Low (15), UAT IN (16), NACv (17–19), NIC supplement C (20). ME 11 is
 * reserved here, having carried Position Offset Applied in version 1, as are ME 13–14.
 */
public class SurfaceCapabilityClassCodeV2 extends AbstractMEField
        implements SurfaceCapabilityClassCodeV2V3 {

    private static final long serialVersionUID = -1607043118929934720L;
     ...
     **/
    protected SurfaceCapabilityClassCodeV2() {
    }
     ...
     */
    public SurfaceCapabilityClassCodeV2(int encoded) {
