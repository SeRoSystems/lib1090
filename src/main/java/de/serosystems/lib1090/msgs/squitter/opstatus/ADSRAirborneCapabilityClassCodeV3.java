...
import de.serosystems.lib1090.msgs.squitter.AirborneCapabilityClassCodeV3;

/**
 * The Capability Class (CC) Code of an ADS-R version 3 airborne operational status message, ME 9–24.
 * <p>
 * Identical to {@link AirborneCapabilityClassCodeV3} but for ME bit 20, which ADS-R defines as NIC
 * supplement B where ADS-B reserves it.
 */
public class ADSRAirborneCapabilityClassCodeV3 extends AbstractMEField
        implements AirborneCapabilityClassCodeV3, ADSRAirborneCapabilityClassCode {

    private static final long serialVersionUID = 3390755124811663086L;
     ...
     **/
    protected ADSRAirborneCapabilityClassCodeV3() {
    }
     ...
     */
    public ADSRAirborneCapabilityClassCodeV3(int encoded) {
