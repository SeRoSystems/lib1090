 ...
 * the ADS-B message set with ED-102B: ED-102B §2.2.3.2.6.3 and §2.2.3.2.6.4 are explicitly marked
 * "Reserved Section...removed and no longer applicable", and current ED-102B §2.2.3.2.6.5 states
 * that Airborne Velocity Message subtypes 3-7 "are not specified" and are reserved for future
 * expansion. The governing former-standard reference is DO-260B §2.2.3.2.6.3 (subtype=3, subsonic)
 * resp. DO-260B §2.2.3.2.6.4 (subtype=4, supersonic).
 */
public interface AirspeedHeadingMsg extends AirborneVelocityMsg {
     ...
     *
     * @return the flag indicates whether heading is available or not, DO-260B §2.2.3.2.6.3.6
    ...
    /**
     * @return the raw encoded airspeed field, DO-260B §2.2.3.2.6.3.9 (subsonic) resp. §2.2.3.2.6.4.9
     * (supersonic)
     */
     ...
     * whether this value is valid. DO-260B §2.2.3.2.6.3.7 (subsonic) resp. §2.2.3.2.6.4.7
     * (supersonic)
     */
     ...
     * DO-260B §2.2.3.2.6.3.8 (subsonic) resp. §2.2.3.2.6.4.8 (supersonic)
     */
