...
/**
 * Decoder for ADS-B airborne position messages (version 1), as defined in ED-102B Appendix N §N.5.2 Figure N-8 (legacy format retained for backward compatibility).
 */
