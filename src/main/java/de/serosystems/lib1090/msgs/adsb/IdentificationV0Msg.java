...
/**
 * Decoder for ADS-B version 0 identification messages, as defined in
 * ED-102B Appendix N §N.5.1 Figure N-3 (legacy format retained for backward compatibility). Individual callsign characters are
