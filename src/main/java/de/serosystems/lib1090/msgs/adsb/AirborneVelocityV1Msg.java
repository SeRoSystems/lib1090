...
/**
 * Marker interface for ADS-B version 1 airborne velocity messages. Implemented both by the
 ...
 * Navigation Accuracy Category for Velocity (NAC_V) subfield, ED-102A §2.2.3.2.6.1.5/§2.2.3.2.6.2.5
 * (ground speed) and §2.2.3.2.6.3.5/§2.2.3.2.6.4.5 (airspeed/heading), is grounded by {@link NACvMsg}.
 */
public interface AirborneVelocityV1Msg extends AirborneVelocityMsg, IFRCapabilityMsg, IntentChangeMsg, NACvMsg {
}
