...
/**
 * Decoder for ADS-B version 2 identification messages, as defined in
 * ED-102B Appendix N §N.5.3 Figure N-18 (legacy format retained for backward compatibility). Individual callsign characters are
...
public class IdentificationV2Msg extends ExtendedSquitter implements Serializable, IdentificationMsg, ADSBMsg {
    ...
    private static final long serialVersionUID = 6141537266238602283L;
    ...
    public String getEmitterCategory() {
        return Identification.categoryDescription(getFormatTypeCode(), emitterCategory, 2);
    }

    @Override
    public String toString() {
        return "IdentificationV2Msg{" + super.toString() +
