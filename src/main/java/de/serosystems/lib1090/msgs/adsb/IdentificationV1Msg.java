...
/**
 * Decoder for ADS-B version 1 identification messages, as defined in
 * ED-102B Appendix N §N.5.2 Figure N-10 (legacy format retained for backward compatibility). Individual callsign characters are
