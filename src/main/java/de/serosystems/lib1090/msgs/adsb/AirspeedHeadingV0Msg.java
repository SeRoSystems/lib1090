 ...
 */
public class AirspeedHeadingV0Msg extends ExtendedSquitter implements Serializable, AirspeedHeadingMsg, AirborneVelocityV0Msg {
    ...
    public AirspeedHeadingV0Msg(ExtendedSquitter squitter) throws BadFormatException {
        super(squitter);
        setType(subtype.ADSB_AIRSPEED_V0);
