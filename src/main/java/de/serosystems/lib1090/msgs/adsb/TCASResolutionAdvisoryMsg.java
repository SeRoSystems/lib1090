...
public class TCASResolutionAdvisoryMsg extends ExtendedSquitter implements Serializable, ADSBMsg {
     ...
     * see ICAO Annex 10 Volume IV §4.3.8.4.2.2.1.1
     */
    ...
    /**
     * @return 4 bits which indicate all currently active RACs; see ICAO Annex 10 Volume IV §4.3.8.4.2.2.1.2
     */
     ...
     * see ICAO Annex 10 Volume IV §4.3.8.4.2.2.1.3; not present for TCAS 6 systems
     */
     ...
     * see ICAO Annex 10 Volume IV §4.3.8.4.2.2.1.4; not present for TCAS 6 systems
     */
    ...
    /**
     * Threat type indicator according to ICAO Annex 10 Volume IV §4.3.8.4.2.2.1.5.
     * <ul>
     ...
     * see ICAO Annex 10 Volume IV §4.3.8.4.2.2.1.6; not present for TCAS 6 systems
     */
