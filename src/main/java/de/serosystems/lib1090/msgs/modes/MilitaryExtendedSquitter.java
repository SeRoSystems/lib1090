...
/**
 * Decoder for the Mode S military extended squitter (DF=19), as defined in ICAO
 * Annex 10 Volume IV §3.1.2.8.8 — a growth option for military applications.<br>
 * Note: §3.1.2.8.8.2 defines only the 3-bit Application Field (AF) as fully reserved
